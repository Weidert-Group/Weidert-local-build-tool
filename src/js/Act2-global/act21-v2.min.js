...
var act={debounce:function(e,a){var t=null;return function(){var s=this,i=arguments;clearTimeout(t),t=setTimeout(function(){e.apply(s,i)},a)}},throttle:function(e,a,t){var s,i;return a||(a=250),function(){var n=t||this,o=+new Date,r=arguments;s&&o<s+a?(clearTimeout(i),i=setTimeout(function(){s=o,e.apply(n,r)},a)):(s=o,e.apply(n,r))}},hex:function(e){return(e=e.match(/^rgba?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?/i))&&4===e.length?"#"+("0"+parseInt(e[1],10).toString(16)).slice(-2)+("0"+parseInt(e[2],10).toString(16)).slice(-2)+("0"+parseInt(e[3],10).toString(16)).slice(-2):""}};jQuery.fn.extend({eqh:function(){function e(a,t){var s=0,i=0;a.css("min-height",a.outerHeight()),ResizeSensor.detach(t),t.addClass("no-transition").css("min-height","").each(function(e){var a=$(this).outerHeight();a>s&&(s=a,i=e)}),t.not(t.eq(i)).css("min-height",s),new ResizeSensor(t,act.debounce(function(){e(a,t)},10)),t.removeClass("no-transition"),a.css("min-height","")}this.each(function(){var a=$(this);if(a.is(".eqh-container")){var t=a.find(".eqh-item:not(.widget-type-custom_widget:has(.cm-col)), .eqh-item.widget-type-custom_widget .cm-col").filter(function(e){return $(this).closest(".eqh-container").is(a)});t&&(e(a,t),new ResizeSensor(t,act.debounce(function(){e(a,t)},10)))}})}}),jQuery(function(e){function a(e){var a=e,t=a.closest(".sticky-parent"),n=a.is('[class*="offset-"]')?parseInt(a.attr("class").match(/offset-\d+/)[0].replace("offset-","")):0,o=a.parent(".sticky-item-wrapper"),l=o.prev(".sticky-item-ref"),c=r.scrollTop(),d=r.width(),h=a.outerHeight(!0),p=t.outerHeight(),f=parseInt(t.css("padding-bottom"))+parseInt(t.css("border-bottom-width")),u=t.offset().top,m=l.offset().top,v=l.offset().left,g=l.width();d<=s&&a.hasClass("md-cancel")||d<=i&&!a.hasClass("no-cancel")?(o.removeAttr("style"),l.css("height",0)):c>=m-n?c<u+p-f-h-n?(o.css({position:"fixed",left:v,top:n,bottom:"auto",width:g}).removeClass("flat"),l.css("height",h)):(o.css({position:"absolute",left:v,top:"auto",bottom:f,width:g}).addClass("flat"),l.css("height",h)):(o.removeAttr("style").removeClass("flat"),l.css("height",0))}e(document);var t,s,i,n,o,r=e(window),l=e("html, body"),c=e("html"),d=e("body");window.location.hash&&(t=window.location.hash.replace(/^.*?(#|$)/,"")),d.prepend('<div class="media-md"></div><div class="media-sm"></div><div class="media-xs"></div><div class="theme-color bg-theme"></div>'),e(".media-md").eq(0).each(function(){var a=e(this),t=a.width();d.attr("data-media-md",t),s=t,a.remove()}),e(".media-sm").eq(0).each(function(){var a=e(this),t=a.width();d.attr("data-media-sm",t),i=t,a.remove()}),e(".media-xs").eq(0).each(function(){var a=e(this),t=a.width();d.attr("data-media-xs",t),n=t,a.remove()}),e(".theme-color").eq(0).each(function(){var a=e(this),t=act.hex(a.css("background-color"));d.attr("data-theme-color",t),o=t,a.remove()}),d.fitVids(),e(".fluid-width-video-wrapper").parent(".hs-responsive-embed").removeClass("hs-responsive-embed hs-responsive-embed-youtube hs-responsive-embed-vimeo"),e(".cta_button.button").initialize(function(){e(this).removeAttr("title")}),e(".eqh-container").eqh(),e(".menu-bar li.hs-item-has-children").each(function(){var a=e(this);0==a.find("ul").length&&a.removeClass("hs-item-has-children")}),e(".accordion-menu .hs-menu-wrapper li.hs-item-has-children ul").each(function(){e(this).closest("li").append('<span class="expand-level"></span>')}),e('.accordion-menu .expand-level, .accordion-menu li:has(.expand-level) > a[href="javascript:;"]').on("click",function(){var a=e(this).closest("li");a.closest("li"),a.hasClass("expanded")?(a.removeClass("expanded").find("ul").addClass("hidden").find(".expanded").removeClass("expanded"),a.siblings().removeClass("expanded").find("ul").addClass("hidden").find("li.expanded").removeClass("expanded")):(a.addClass("expanded").find("> ul").removeClass("hidden"),a.siblings().removeClass("expanded").find("ul").addClass("hidden").find("li.expanded").removeClass("expanded"))}),e("[data-reveal]").each(function(){var a=e(this),t=e("#"+a.attr("data-reveal"));a.on("click",function(){return a.toggleClass("on"),t.toggleClass("on"),!1})}),e("[data-slide-menu]").each(function(){var a=e(this),t=a.attr("data-slide-menu"),s=e('[data-slide-menu="'+t+'"]').not(this),i=e("#"+t),n=i.closest(".row-fluid-wrapper").next(".row-fluid-wrapper").find(".slide-menu-overlay");a.on("click",function(){a.toggleClass("on"),i.toggleClass("on"),s.toggleClass("on"),n.toggleClass("on"),i.hasClass("on")?d.addClass("noscroll"):d.removeClass("noscroll"),e("[data-slide-menu]").not(this).not(s).removeClass("on"),e(".slide-menu").not(i).removeClass("on"),e(".slide-menu-overlay").not(n).removeClass("on")}),n.on("click",function(){a.removeClass("on"),i.removeClass("on"),s.removeClass("on"),n.removeClass("on"),d.removeClass("noscroll")})}),e('.slide-menu a[href^="#"], .slide-menu a[href^="/#"]').on("click",function(){e("[data-slide-menu], .slide-menu, .slide-menu-overlay").removeClass("on"),d.removeClass("noscroll")}),e(".sticky-header").each(function(){var a=e(this),t=a.closest(".sticky-header-options"),s=e(t.attr("data-linked-to"));s.length>0?r.on("load resize scroll",act.throttle(function(){r.scrollTop()>s.height()+s.offset().top?(a.addClass("on"),s.addClass("off")):(a.removeClass("on"),s.removeClass("off"))},10)):a.addClass("on")}),e(".hs-item-has-children:not(:has(ul))").removeClass("hs-item-has-children"),e(".map-section").append('<div class="map-overlay" />'),e(".map-overlay").on("click",function(){e(this).css("pointer-events","none")}),e('[class*="scroll-next-"]').each(function(){var a=e(this);a.closest(".row-fluid-wrapper").next(".row-fluid-wrapper").find(".content-section, .hero-slider, .hero-banner").length>0&&(a.hasClass("scroll-offset-sticky-header")?a.append('<a class="sn-arrow sn-offset-sticky-header" href="#"><i class="fa fa-chevron-down"></i></a>'):a.append('<a class="sn-arrow" href="#"><i class="fa fa-chevron-down"></i></a>'))}),e(".sn-arrow").on("click",function(){var a=e(this).closest(".row-fluid-wrapper").next(".row-fluid-wrapper").find(".content-section, .hero-slider, .hero-banner").offset().top,t=0;return e(this).hasClass("sn-offset-sticky-header")&&e(".sticky-header").length>0&&(t=e(".sticky-header").height()-1),l.animate({scrollTop:a-t},300,"easeOutExpo"),!1}),d.prepend('<a name="top"></a>').append('<span class="scroll-to-top"><i class="fa fa-chevron-up"></i></span>');var h=e(".scroll-to-top");h.on("click",function(){l.animate({scrollTop:0},300,"easeOutExpo")}),r.on("load scroll",act.throttle(function(){r.scrollTop()>95?h.addClass("active"):h.removeClass("active")},250)),0==e("html.lt-ie9").length&&e("a[href*=\\#]:not([href=\\#], .popup-content, .tabs-nav a, .advanced-gallery-link)").on("click",function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if((a=a.length?a:e('[name="'+this.hash.slice(1)+'"]')).length){var t=a.offset().top,s=0;return a.is('[class*="offset-"]')&&(s=parseInt(a.attr("class").match(/offset-\d+/)[0].replace("offset-",""))),"top"==a.attr("name")&&(t=0),l.animate({scrollTop:t-s},300,"easeOutExpo"),!1}}}),e(".accordion-header").on("click",function(){var a=e(this).closest(".accordion-item"),t=a.attr("data-accordion-group");a.toggleClass("collapsed"),""!=t&&e('.accordion-item[data-accordion-group="'+t+'"]').not(e(this).closest(".accordion-item")).addClass("collapsed")});var p=e("body").find('.accordion-item[data-accordion-anchor="'+t+'"]').first();p.length>0&&(p.removeClass("collapsed"),e('.accordion-item[data-accordion-group="'+p.attr("data-accordion-group")+'"]').not(p.closest(".accordion-item")).addClass("collapsed"),l.animate({scrollTop:p.offset().top-100},300,"easeOutExpo")),e(".tabs-container").each(function(){var a=e(this);if(a.find('.tabs-nav a[href^="#"]').each(function(){var t=e(this),s=t.attr("href"),i=a.find(".tab-group"+s).eq(0);i.length>0&&(a.is(".responsive")||a.is(".md-responsive")?(t.addClass("tab-link").clone().addClass("mirror").prependTo(i.closest(".row-fluid-wrapper")),t.closest("li").addClass("duplicate")):t.addClass("tab-link"))}),0==a.find(".tab-group.active").length){var t=a.find(".tab-group").eq(0);t.addClass("active"),e('.tab-link[href="#'+t.attr("id")+'"]').addClass("active")}else e('.tab-link[href="#'+a.find(".tab-group.active").eq(0).attr("id")+'"]').addClass("active");a.find(".tab-link").on("click",function(){var t=e(this),s=a.find(".tab-group"+t.attr("href"));if(s.length>0){if(a.find(".tab-group").removeClass("active"),a.find(".tab-link").removeClass("active"),s.addClass("active"),a.find('.tab-link[href="'+t.attr("href")+'"]').addClass("active"),t.hasClass("mirror")){var i=t.offset().top;l.animate({scrollTop:i-50},300,"easeOutExpo")}r.trigger("scroll"),r.trigger("tabChanged"),s.find(".slider-container").nboslick("refresh"),s.is(".eqh-container")&&s.eqh(),s.find(".eqh-container").eqh(),e.force_appear()}return!1})});var f=e("body").find(".tab-group#"+t).first(),u=f.closest(".tabs-container");if(f.length>0){u.find(".tab-group").removeClass("active"),f.addClass("active"),u.find(".tab-link").removeClass("active"),u.find(".tab-link[href=#"+t+"]").addClass("active");var m=f.offset().top,v=e(".sticky-header").length>0?e(".sticky-header").height():0;l.animate({scrollTop:m-v-30},300,"easeOutExpo")}e(".read-more-button-expand").on("click",function(){return e(this).closest(".read-more").removeClass("collapsed"),!1}),e(".read-more-button-collapse").on("click",function(){var a=e(this).closest(".read-more"),t=a.offset().top;return a.addClass("collapsed"),l.animate({scrollTop:t-100},300,"easeOutExpo"),!1}),e(".content-section .bg-img").each(function(){var a=e(this),t=a.closest(".content-section"),s=a.find("img").eq(0);if(s.length>0){var i=s.attr("src"),n=s.attr("alt");a.hasClass("bg-parallax")?(t.attr("data-parallax","scroll").attr("data-image-src",i).attr("data-image-alt",n||"").parallax({iosFix:!0,bleed:200}),new ResizeSensor(t,function(){t.trigger("resize.px.parallax")})):t.css("background-image","url('"+i+"')").addClass("bg-img-defined")}}),e(".hero-banner .video-url, .content-section .video-url").each(function(){var a=e(this),t=a.closest(".hero-banner, .content-section"),s=a.text().trim();""!=s&&t.addClass("video-bg").prepend('<div class="video-object"><video autoplay playsinline muted loop src="'+s+'"></video></div>')});var g=e(".fullscreen-search"),C=g.find(".hs-input");g.each(function(){c.addClass("fss-on"),g.appendTo(d),g.find("form").before('<div class="fss-overlay"/>'),g.find(".hs-form label").length>0&&C.attr("placeholder",g.find(".hs-form label").text()),g.find(".hs-form label").remove(),g.find(".hs-button").html('<i class="fa fa-search"></i>'),g.hasClass("with-close")&&g.append('<a class="fss-close-btn" href="#"><i class="fa fa-times"></i></a>'),e(".fss-open-btn").on("click",function(){return c.addClass("fullscreen-search-open"),/iPad|iPhone|iPod/g.test(navigator.userAgent)||setTimeout(function(){C.focus()},250),!1}),e(".fss-close-btn").on("click",function(){return c.removeClass("fullscreen-search-open"),!1}),e(".fullscreen-search:not(.with-close.only-close)").find(".fss-overlay").on("click",function(){c.removeClass("fullscreen-search-open")})}),e(".rss-cards .hs-rss-item").initialize(function(){var a=e(this),t=a.closest(".rss-cards"),s=t.find(".hs-rss-module").eq(0);if(t.hasClass("equal-height")&&a.find(".hs-rss-description a").eq(0).wrap('<div class="rss-more" />'),t.hasClass("full-links")&&a.append('<a class="full-link" href="'+a.find("a.hs-rss-title").attr("href")+'"></a>'),a.html('<div class="rss-card">'+a.html()+"</div>"),!t.hasClass("no-masonry")&&!t.hasClass("one-column"))s.isotope({itemSelector:".hs-rss-item",isFitWidth:!0})}),e(".listing-container").each(function(){function a(e){var a=g;"*"!=p&&(a+="["+f+'*="'+p+'"]'),a+="["+u+'="'+e+'"]',function(e){C.isotope({filter:e})}(a+=":not(.search-ignored)")}function s(){var t=C.children(g).not(".search-ignored").length,s=(Math.ceil(t/d),1),o=1,r=g;"*"!=p&&(r+="["+f+'*="'+p+'"]'),C.children(r).not(".search-ignored").each(function(){s>d&&(o++,s=1),e(this).attr(u,o),s++}),h=o,n.html("");for(var c=0;c<h;c++){if(0==c)m="active";else var m="";var v=e('<a href="javascript:;" class="listing-page-number '+m+'" '+u+'="'+(c+1)+'"></a>');v.html(c+1),v.on("click",function(){var t=e(this),s=t.attr(u);t.siblings().removeClass("active"),t.addClass("active"),a(s);var n=i.find(".scroll-here-from-pagination").eq(0);if(n.length>0){var o=n.is('[class*="offset-"]')?parseInt(n.attr("class").match(/offset-\d+/)[0].replace("offset-","")):0;l.animate({scrollTop:n.offset().top-o},500,"easeOutExpo")}}),h>1?v.appendTo(n):n.html("")}}var i=e(this),n=i.find(".listing-pagination"),o=i.find(".listing-menu"),r=i.find(".listing-pagination-options"),c=i.find(".listing-search input"),d=10,h=1,p="*",f="data-filter",u="data-page",m={percentPosition:!0,layoutMode:"masonry"};o.find("a.active").first().each(function(){p=e(this).attr("href").replace("#","")}),i.hasClass("no-masonry")&&(Isotope.Item.prototype._create=function(){this.id=this.layout.itemGUID++,this._transn={ingProperties:{},clean:{},onEnd:{}},this.sortData={}},Isotope.Item.prototype.layoutPosition=function(){this.emitEvent("layout",[this])},Isotope.prototype.arrange=function(e){this.option(e),this._getIsInstant(),this.filteredItems=this._filter(this.items),this._isLayoutInited=!0},Isotope.LayoutMode.create("none"),m.layoutMode="none");var v=i.find(".listing-items > .hs_cos_wrapper_type_widget_container");if(v.length>0){(C=v).find("> .hs_cos_wrapper").addClass("listing-cell");var g=".listing-cell";C.find(".listing-filter").each(function(){var a=e(this);a.closest(".listing-cell").attr("data-filter",a.attr("data-filter"))})}else{var C=i.find(".listing-items");C.addClass("drag"),C.find(".listing-item").closest(".row-fluid-wrapper").addClass("listing-cell"),e(g=".row-fluid-wrapper.listing-cell").each(function(){var a=e(this).find(".listing-filter").first();e(this).attr("data-filter",a.attr("data-filter").replace(" ","").replace(","," "))})}m.itemSelector=g,""!=r.attr("data-items-per-page")&&(d=r.attr("data-items-per-page")),o.each(function(){var a=e(this);0==a.find("a.active").eq(0).length&&a.find('a[href="#all"], a[href="#All"]').addClass("active")}),C.isotope(m),new ResizeSensor(e(g),function(){C.isotope(m)}),o.find('a[href^="#"]').on("click",function(){var t,n=e(this);t="#all"==n.attr("href").toLowerCase()?"*":n.attr("href").replace("#",""),n.closest("li").siblings().find("a").removeClass("active"),n.addClass("active"),p=t,e(g).removeClass("search-ignored"),c.val("");var o=i.find(".scroll-here-from-menu").eq(0);if(o.length>0){var r=o.is('[class*="offset-"]')?parseInt(o.attr("class").match(/offset-\d+/)[0].replace("offset-","")):0;l.animate({scrollTop:o.offset().top-r},500,"easeOutExpo")}return s(),a(1),!1}),o.find('a[href="#'+t+'"]').first().each(function(){var i,n=e(this);if(n.length>0)return i="all"==t.toLowerCase()?"*":t,o.find("a").removeClass("active"),n.addClass("active"),p=i,s(),a(1),!1}),s(),a(1),c.on("keyup",act.debounce(function(){var t=c.val(),i=new RegExp(t,"gi");if(""==t){var n=o.find("a.active").eq(0);p="#all"==n.attr("href").toLowerCase()?"*":n.attr("href").replace("#",""),e(g).removeClass("search-ignored"),s(),a(1)}else{e(g).addClass("search-ignored"),C.isotope({filter:function(){return!i||e(this).text().match(i)}});var r=C.isotope("getFilteredItemElements");e.each(r,function(){e(this).removeClass("search-ignored")}),s(),a(1)}},250))}),e(".hero-slider .slick-slide").css("background-image",function(){var a=e(this).find("img");return a.attr("data-lazy")?"url('"+a.attr("data-lazy")+"')":"url('"+a.attr("src")+"')"}),-1!==navigator.appVersion.indexOf("MSIE 10")||window.MSInputMethodContext&&document.documentMode||!Modernizr.csscalc||!Modernizr.cssvhunit?r.on("load resize",act.debounce(function(){var a=e(".header-wrapper").height(),t=r.height();e(".hero-slider.full-vh").each(function(){var s=e(this),i=s.find(".slick-track"),n=(i.height(),0);i.css({height:"auto","min-height":0}),s.hasClass("minus-header")&&(t-=a),s.find(".slick-slide").each(function(){var a=e(this).height();a>n&&(n=a)}),t>n?i.height(t):i.height(n)}).css("min-height",0).addClass("done")},250)):r.on("load resize",act.debounce(function(){var a=e(".header-wrapper").height();e(".hero-slider.full-vh.minus-header .slick-track").css("min-height",function(){return"calc(100vh - "+a+"px)"}).closest(".hero-slider").css("min-height",0).addClass("done")},250)),e("a.popup-image, .popup-image a").nboMagnificPopup({type:"image",mainClass:"nbomfp-fade",tClose:"",closeMarkup:'<div class="popup-close"></div>'}),e("a.popup-iframe, .popup-iframe a").each(function(){var a=e(this).hasClass("enable-on-mobile")||e(this).closest(".popup-iframe").hasClass("enable-on-mobile");e(this).nboMagnificPopup({type:"iframe",disableOn:function(){return!(r.width()<=i&&!a)},mainClass:"nbomfp-fade",tClose:"",closeMarkup:'<div class="popup-close"></div>',removalDelay:160,preloader:!1,fixedContentPos:!1})}),e("a.popup-content, .popup-content a").nboMagnificPopup({type:"inline",mainClass:"nbomfp-fade",tClose:"",closeMarkup:'<div class="popup-close"></div>',removalDelay:100,callbacks:{open:function(){e.force_appear(),r.trigger("resize")}}}),e(".popup-image a:not([title])").each(function(){var a=e(this),t=a.find("img").eq(0).attr("title");""!=t&&a.attr("title",t)}),e('.advanced-gallery img:not(".change-image img")').each(function(){var a=e(this),t=(a.closest(".advanced-gallery"),a.attr("src")),s=a.attr("title");0==a.closest("a").length&&a.wrap('<a href="'+t+'"></a>');var i=a.closest("a");""!=s&&(i.attr("data-title",s),a.removeAttr("title")),a.is(".video img")&&i.addClass("video")}),e(".advanced-gallery").each(function(){e(this).find("a:not(.external-link a)").nboMagnificPopup({type:"image",mainClass:"nbomfp-fade",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1],tPrev:"",tNext:""},iframe:{patterns:{youtube:{src:"//www.youtube.com/embed/%id%?autoplay=1&amp;rel=0"}}},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.',titleSrc:function(e){return e.el.attr("data-title")}},tClose:"",closeMarkup:'<div class="popup-close"></div>',callbacks:{elementParse:function(e){"video"==e.el.context.className?e.type="iframe":e.type="image"}}})}),e(".advanced-gallery-link").on("click",function(a){a.preventDefault(),e(e(this).attr("href")+" a:not(.external-link a)").first().nboMagnificPopup("open")}),e(".popup-target").each(function(){var a=e(this).attr("id");a==t&&e.nboMagnificPopup.open({items:{src:"#"+a,type:"inline"},tClose:"",closeMarkup:'<div class="popup-close"></div>'})}),e(".popup-group").each(function(){e(this).find("a:not(.external-link a)").nboMagnificPopup({type:"inline",tLoading:"Loading...",mainClass:"nbomfp-fade",gallery:{enabled:!0,tPrev:"",tNext:""},tClose:"",closeMarkup:'<div class="popup-close"></div>'})}),-1!==navigator.appVersion.indexOf("MSIE 10")&&c.addClass("is-ie10"),window.MSInputMethodContext&&document.documentMode&&c.addClass("is-ie11"),e(".form-box").each(function(){var a=e(this);0==a.find(".form-box-header").length&&a.addClass("no-title")}),new WOW({boxClass:"reveal"}).init(),e(".slick-slide .caption.superimpose").closest(".hs_cos_gallery_main").addClass("with-superimposed-caption"),e(".slider-container").each(function(){var a=e(this),t={},o=767;if(a.is(".widget-type-widget_container"))l=e("> .hs_cos_wrapper_widget_container",a);else var l=a;t.adaptiveHeight=!!a.hasClass("adaptive-height"),t.variableWidth=!!a.hasClass("variable-width"),t.autoplay=!!a.hasClass("autoplay"),t.autoplaySpeed=a.is('[class*="autoplay-speed-"]')?parseInt(a.attr("class").match(/autoplay-speed-\d+/)[0].replace("autoplay-speed-","")):3e3,t.speed=a.is('[class*="animation-speed-"]')?parseInt(a.attr("class").match(/animation-speed-\d+/)[0].replace("animation-speed-","")):300,t.arrows=!!a.hasClass("arrows"),t.dots=!!a.hasClass("dots"),t.fade=!!a.hasClass("fade"),t.centerMode=!!a.hasClass("center-mode"),t.centerPadding=a.is('[class*="center-padding-"]')?a.attr("class").match(/center-padding-\d+/)[0].replace("center-padding-","")+"px":"50px",t.infinite=!!a.hasClass("infinite"),t.pauseOnHover=!!a.hasClass("pause-on-hover"),t.slidesToShow=a.is('[class*="slides-to-show-"]')?parseInt(a.attr("class").match(/slides-to-show-\d+/)[0].replace("slides-to-show-","")):1,t.slidesToScroll=a.is('[class*="slides-to-scroll-"]')?parseInt(a.attr("class").match(/slides-to-scroll-\d+/)[0].replace("slides-to-scroll-","")):1,t.vertical=!!a.hasClass("vertical"),t.verticalSwiping=!!a.hasClass("vertical-swiping"),t.draggable=!c.hasClass("hs-inline-edit")&&!a.hasClass("not-draggable"),t.swipe=!a.hasClass("not-swipeable"),a.hasClass("md-stack")?o=s:a.hasClass("sm-stack")?o=i:a.hasClass("xs-stack")&&(o=n),t.responsive=[{breakpoint:o,settings:{arrows:!0,centerMode:!1,centerPadding:"0",slidesToShow:1}}],l.on("init",function(t,s){r.trigger("resize.px.parallax"),e.force_appear(),a.eqh(),a.find(".eqh-container").eqh(),r.trigger("sliderContainerInit")}),l.on("afterChange",function(t,s){r.trigger("resize.px.parallax"),e.force_appear(),a.eqh(),a.find(".eqh-container").eqh(),r.trigger("sliderContainerChanged")}),l.nboslick(t)}),e(".hero-slider-v2 .eqh-item").addClass("eqh-never-cancel"),e(".header-overlap").eq(0).length>0&&d.addClass("header-overlap"),e(".full-vh.minus-header").each(function(){var a=e(this);r.on("load resize sliderContainerInit sliderContainerChanged",act.debounce(function(){var t=e(".header-wrapper").height();a.css("min-height",function(){return"calc(100vh - "+t+"px)"}),r.trigger("resize.px.parallax"),a.addClass("done")},250))}),e(".sticky-item").each(function(){var t=e(this);t.wrap('<div class="sticky-item-wrapper" />'),t.parent(".sticky-item-wrapper").before('<div class="sticky-item-ref" style="height: 0;" />'),r.on("load scroll resize tabChanged",function(){a(t)}),new ResizeSensor(t,function(){a(t)}),new ResizeSensor(t.parent(".sticky-item-wrapper").prev(".sticky-item-ref"),function(){a(t)}),new ResizeSensor(t.closest(".sticky-parent"),function(){a(t)})}),e(".mega-menu-branch").each(function(){var a=e(this),t=a.closest(".mega-menu-parent"),s=a.closest(".mega-menu-options"),i=a.closest(".mega-menu").find(".mega-menu-branch").not(this),n=e(s.attr("data-menu"));if(n.length>0&&a.is('[class*="activated-by-"]')){var o=parseInt(a.attr("class").match(/activated-by-\d+/)[0].replace("activated-by-","")),l=n.find(".hs-menu-wrapper > ul > li").eq(o-1),c=l.siblings(),d=s.attr("data-parent-active-class")?s.attr("data-parent-active-class"):"";l.addClass("mega-menuized"),l.on("mouseenter",act.debounce(function(){i.removeClass("active"),a.addClass("active"),c.removeClass("mega-menuized-active"),l.addClass("mega-menuized-active"),t.addClass(d)},200)).on("mouseleave",act.debounce(function(e){a.is(":hover")||(a.removeClass("active"),l.removeClass("mega-menuized-active"),t.removeClass(d))},200)),a.on("mouseleave",act.debounce(function(){l.each(function(){e(this).is(":hover")||(a.removeClass("active"),l.removeClass("mega-menuized-active"),t.removeClass(d))})},200)),r.on("resize scroll",act.debounce(function(){a.removeClass("active"),l.removeClass("mega-menuized-active"),t.removeClass(d)},50))}});var b=e(".hs-menu-wrapper"),w=b.find("> ul > li"),y=(b.find("> ul > li > a"),e(e(".page-section").get().reverse())),k={},x=[];b.find('a[href^="http://#"], a[href^="https://#"]').each(function(){var a=e(this),t=a.attr("href").replace("http://#","#").replace("https://#","#");a.attr("href",t)}),y.each(function(){var a=e(this).attr("id");k[a]=b.find("> ul > li > a[href=#"+a+"]"),e(this).is('[class*="active-offset-"]')?x[a]=parseInt(e(this).attr("class").match(/active-offset-\d+/)[0].replace("active-offset-",""))+1:x[a]=200}),r.on("load scroll resize",act.throttle(function(){var a=r.scrollTop();y.each(function(){var t=e(this),s=t.offset().top,i=t.attr("id"),n=k[i].closest("li");if(a>=s-x[i])return n.hasClass("active")||(w.removeClass("active"),n.addClass("active")),!1;n.removeClass("active")})},100)),e(".circle-loader").appear({force_process:!0}).on("appear",function(){var a=e(this),t=a.closest(".circle-loader-wrapper"),s=o,i=o;a.attr("data-color-1")&&(s=a.attr("data-color-1")),a.attr("data-color-2")&&(i=a.attr("data-color-2")),a.data("inited")||(a.on("circle-animation-start",function(e){t.addClass("started")}).circleProgress({size:400,fill:{gradient:[s,i]}}).on("circle-animation-progress",function(e,s,i){var n=a.find(".number");if(a.is("[data-custom-number]")){var o=a.attr("data-custom-number");t.hasClass("v2")?n.html(Math.round(s*o)):n.html(Math.round(i*o))}else a.is("[data-custom-text]")?n.html(a.attr("data-custom-text")):n.html(Math.round(100*i)+'<span class="percent">%</span>')}).on("circle-animation-end",function(e){t.addClass("done")}),a.data("inited",!0))}),e(".bar-loader").appear({force_process:!0}).on("appear",function(){var a=e(this);a.addClass("started").find(".number").one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(){a.addClass("done")})}),plyr.setup(".media-player",{iconUrl:"https://cdn2.hubspot.net/hubfs/273774/mp/themes/Act-Theme/images/plyr.svg",blankUrl:"https://cdn2.hubspot.net/hubfs/273774/mp/themes/Act-Theme/videos/plyr.mp4",controls:["play-large","play","progress","current-time","mute","volume","fullscreen"]}),e(".content-card-image img").closest(".content-card").addClass("with-image"),e(".content-card-link a").closest(".content-card").addClass("with-link"),e(".dated-titles-container").each(function(){var a=e(this);a.find(".dated-title").each(function(){var a=e(this);a.closest(".hs_cos_wrapper").css("order",a.attr("data-dt-order"))}),a.addClass("done")}),e(".one-field-form .hs-input").initialize(function(){var a=e(this),t=a.closest(".hs-form").find(".hs-button").eq(0).outerWidth();a.css("padding-right",t+20)}),r.load(function(){e(".list-type-dropdown").not(".plain-links").each(function(){var a=e(this),t=a.find("ul").eq(0),s=a.find("a"),i=t.find("a.active").eq(0);t.before('<div class="control fade-in">'+i.html()+"</div>");var n=a.find(".control").eq(0);n.click(function(){a.toggleClass("open")}),s.click(function(){n.html(e(this).html()),a.removeClass("open")}),c.click(function(t){e(t.target).is(a)||e(t.target).is(n)||a.removeClass("open")})}),e(".list-type-dropdown.plain-links").each(function(){var a=e(this),t=a.find("h1, h2, h3, h4").eq(0),s=a.find("ul").eq(0),i=a.find("a");s.before('<div class="control fade-in">'+t.html()+"</div>");var n=a.find(".control").eq(0);n.click(function(){a.toggleClass("open")}),c.click(function(t){e(t.target).is(i)||e(t.target).is(n)||a.removeClass("open")})})}),e("#blog-listing-more").click(function(){var a=e(this),t=a.attr("href"),s=e("#blog-listing-container");return e.ajax({url:t,type:"GET",success:function(t){var i=(t=e(t)).find("#blog-listing-container").html(),n=t.find("#blog-listing-more").attr("href");s.append('<div class="blog-listing-new-row fade-in">'+i+"</div>"),n?a.attr("href",n):a.remove()},complete:function(e){setTimeout(function(){s.find(".eqh-container").eqh()},200)}}),!1}),e('[class*="wrapper-class--"]').each(function(){var a=e(this),t=a.attr("class").split(" ");e.each(t,function(){var e=this.match(/wrapper-class--[\s\S]*/);e&&a.closest(".row-fluid-wrapper").addClass(e.toString().replace("wrapper-class--",""))})}),e('[class*="row-class--"]').each(function(){var a=e(this),t=a.attr("class").split(" ");e.each(t,function(){var e=this.match(/row-class--[\s\S]*/);e&&a.closest(".row-fluid").addClass(e.toString().replace("row-class--",""))})}),e('[class*="form-button-class--"] .hs-button').initialize(function(){var a=e(this),t=a.closest('[class*="form-button-class--"]').attr("class").split(" ");e.each(t,function(){var e=this.match(/form-button-class--[\s\S]*/);e&&a.addClass(e.toString().replace("form-button-class--",""))})}),e('[class*="form-title-class--"]').each(function(){var a=e(this),t=a.attr("class").split(" ");e.each(t,function(){var e=this.match(/form-title-class--[\s\S]*/);e&&a.find(".form-title").addClass(e.toString().replace("form-title-class--",""))})}),e(".random-content").each(function(){var a=e(this).find("> *");a.eq(Math.floor(Math.random()*a.length)).addClass("fade-in").show()}),e("body").on("click",".lang-select .globe_class",function(){var a=e(this);a.find("a"),e(this).toggleClass("open"),c.click(function(t){e(t.target).is(a)||a.removeClass("open")}),r.on("scroll",function(){a.removeClass("open")})}),e(".lang-select a.current_lang").initialize(function(){var a=e(this).parent();a.prependTo(a.parent())}),e(".hs-inline-edit .widget-type-raw_jinja").removeAttr("data-widget-type"),e(".slide-menu .control-button .close i.fa.fa-close").addClass("fas fa-times"),e(".legal-consent-container > div").initialize(function(){""==e.trim(e(this).text())&&e(this).addClass("hidden")}),e(".hs-inline-edit .nbomfp-wrap[tabindex]").initialize(function(){e(this).removeAttr("tabindex")})});